            ...
            if revised_demandLetter == 0:  
                ...
                for _, usdc_row in usdc_transactions.iterrows():
                    ...
                    message += (f"Transaction = {index}\n"
                                ...
                                f"You paid - {round(buy_asset_amount, 2):.2f} PHP\n"
                                f"You are supposed to pay - {round(User_should_have_paid_in_php, 2):.2f} PHP\n\n")
...
output_file_path = os.path.join(notifications_dir, 'notifications_summary_donotowe.xlsx')
