    ...
    if isinstance(y, dict):
        for key, value in y.items():
            ...
            if isinstance(value, dict):
                ...
                # Check if list items are all dictionaries
...
# Flatten the JSON recursively until no nested JSON objects remain
flat_data = flatten_json(data, sep="__")

# Convert the flattened data into a DataFrame (as a single row)
df = pd.DataFrame([flat_data])

# Save the DataFrame to an XLSX file
excel_filename = "nojson_v1.xlsx"
